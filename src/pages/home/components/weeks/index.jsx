    ...
    <section className="section__five">
      ...
      <div className="section__five__right">
        ...
        <p className="section__five__right__text">
          Прокачиваем энергию, заложенную числом рождения. Она отражает
          личностные характеристики, те качества, с которыми мы приходим в
          жизнь. Это то, кто я есть. Эта энергия будет сопровождать нас всю
          жизнь. Она может проживаться тобой как в плюсе, так и в минусе. С
          описанием энергии ты получишь список конкретных действия для
          прокачивания энергии, а так же список профессий, которые тебе
          подходят.
        </p>
        <div className="section__five__left__item__responsive section__five__left__item__hide">
          <p className="section__five__left__item__number">2</p>
        ...
        <p className="section__five__right__text">
          ...
          слушаешь свою интуицию, свой внутренний голос. С описанием ты получишь
        ...
        <p className="section__five__right__text">
          ...
          энергии, а так же список профессий, которые тебе подходят.
        </p>
        <div className="section__five__left__item__responsive section__five__left__item__hide">
          <p className="section__five__left__item__number">4</p>
          <p className="section__five__left__item__text">НЕДЕЛЯ</p>
